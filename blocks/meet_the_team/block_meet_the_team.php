 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_meet_the_team extends block_base {

    /**
     * Initialize the block
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_meet_the_team');
    }
    ...
    public function specialization() {
        if (isset($this->config->title)) {
            ...
            $this->title = format_string(get_string('pluginname', 'block_meet_the_team'));
        }
    }
    ...
    public function get_content() {
        ...
        if ($canviewuserdetails) {
            ...
            $this->content->text .= html_writer::tag('p', get_string('cannot_view_user_details', 'block_meet_the_team'));
        }
