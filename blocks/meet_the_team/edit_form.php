...
class block_meet_the_team_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('static', 'config_display_settings_all_users',
            get_string('display_settings_all_users', 'block_meet_the_team'),
            get_string('display_settings_all_users_desc', 'block_meet_the_team'));

        // Profile picture.
        $mform->addElement('advcheckbox', 'config_display_profile_picture',
            get_string('display_profile_picture', 'block_meet_the_team'),'','', array(0, 1));
        
        // Phone 1.
        $mform->addElement('advcheckbox', 'config_display_phone1',
            get_string('display_phone1', 'block_meet_the_team'),'','', array(0, 1));
        
        // Phone 2.
        $mform->addElement('advcheckbox', 'config_display_phone2',
            get_string('display_phone2', 'block_meet_the_team'),'','', array(0, 1));

        // Email.
        $mform->addElement('advcheckbox', 'config_display_email',
            get_string('display_email', 'block_meet_the_team'),'','', array(0, 1));        
        ...
        $mform->addElement('static', 'config_display_custom_role_reminder', 
                               get_string('display_custom_role_reminder', 'block_meet_the_team'),
                                get_string('display_custom_role_reminder_desc', 'block_meet_the_team'));
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_1',
            get_string('display_custom_profile_field_user_1', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_1', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_1', 'block_meet_the_team');
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_2',
            get_string('display_custom_profile_field_user_2', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_2', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_2', 'block_meet_the_team');        
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_3',
            get_string('display_custom_profile_field_user_3', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_3', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_3', 'block_meet_the_team');
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_4',
            get_string('display_custom_profile_field_user_4', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_4', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_4', 'block_meet_the_team');
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_5',
            get_string('display_custom_profile_field_user_5', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_5', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_5', 'block_meet_the_team');
       ...
       $mform->addElement('text', 'config_display_custom_profile_field_user_6',
            get_string('display_custom_profile_field_user_6', 'block_meet_the_team'));
        $mform->setType('config_display_custom_profile_field_user_6', PARAM_TEXT);
        $mform->setDefault('default_custom_profile_field_user_6', 'block_meet_the_team');
