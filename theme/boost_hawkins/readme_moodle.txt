...
* remove folder theme/boost_hawkins/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_hawkins/scss/bootstrap
...
* comment out this line in theme/boost_hawkins/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_hawkins/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_hawkins run "Grunt amd" to compile the bootstrap JS
