...
* remove folder theme/boost_health/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_health/scss/bootstrap
...
* comment out this line in theme/boost_health/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_health/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_health run "Grunt amd" to compile the bootstrap JS
