...
* remove folder theme/boost_bdgpnt/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_bdgpnt/scss/bootstrap
...
* comment out this line in theme/boost_bdgpnt/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_bdgpnt/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_bdgpnt run "Grunt amd" to compile the bootstrap JS
