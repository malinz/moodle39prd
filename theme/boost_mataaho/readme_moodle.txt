...
* remove folder theme/boost_mataaho/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_mataaho/scss/bootstrap
...
* comment out this line in theme/boost_mataaho/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_mataaho/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_mataaho run "Grunt amd" to compile the bootstrap JS
