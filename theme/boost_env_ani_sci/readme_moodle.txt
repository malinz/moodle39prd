...
* remove folder theme/boost_env_ani_sci/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_env_ani_sci/scss/bootstrap
...
* comment out this line in theme/boost_env_ani_sci/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_env_ani_sci/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_env_ani_sci run "Grunt amd" to compile the bootstrap JS
