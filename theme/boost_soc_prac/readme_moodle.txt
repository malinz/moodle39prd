...
* remove folder theme/boost_soc_prac/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_soc_prac/scss/bootstrap
...
* comment out this line in theme/boost_soc_prac/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_soc_prac/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_soc_prac run "Grunt amd" to compile the bootstrap JS
