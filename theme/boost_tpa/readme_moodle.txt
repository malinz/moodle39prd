...
* remove folder theme/boost_tpa/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_tpa/scss/bootstrap
...
* comment out this line in theme/boost_tpa/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_tpa/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_tpa run "Grunt amd" to compile the bootstrap JS
