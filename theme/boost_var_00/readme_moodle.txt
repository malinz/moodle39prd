...
* remove folder theme/boost_var_00/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_var_00/scss/bootstrap
...
* comment out this line in theme/boost_var_00/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_var_00/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_var_00 run "Grunt amd" to compile the bootstrap JS
