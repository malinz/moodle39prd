 ...
 *
 * @module     theme_unitecstandard_boost/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('unitecstandard_boostFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.unitecstandard_boostFormErrorsEnhanced = 1;
            }
        }
    };
});
