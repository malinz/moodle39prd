...
* remove folder theme/unitecstandard_boost/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/unitecstandard_boost/scss/bootstrap
...
* comment out this line in theme/unitecstandard_boost/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/unitecstandard_boost/amd/src/bootstrap (including the subfolder)
...
* in folder theme/unitecstandard_boost run "Grunt amd" to compile the bootstrap JS
