...
* remove folder theme/boost_bld_const/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_bld_const/scss/bootstrap
...
* comment out this line in theme/boost_bld_const/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_bld_const/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_bld_const run "Grunt amd" to compile the bootstrap JS
