...
* remove folder theme/boost_comm_stud/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_comm_stud/scss/bootstrap
...
* comment out this line in theme/boost_comm_stud/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_comm_stud/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_comm_stud run "Grunt amd" to compile the bootstrap JS
