...
* remove folder theme/boost_swift/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_swift/scss/bootstrap
...
* comment out this line in theme/boost_swift/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_swift/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_swift run "Grunt amd" to compile the bootstrap JS
