...
* remove folder theme/boost_police/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_police/scss/bootstrap
...
* comment out this line in theme/boost_police/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_police/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_police run "Grunt amd" to compile the bootstrap JS
