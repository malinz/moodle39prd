 ...
 *
 * @module     theme_boost_app_tech/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_app_techFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_app_techFormErrorsEnhanced = 1;
            }
        }
    };
});
