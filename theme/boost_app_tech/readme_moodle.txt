...
* remove folder theme/boost_app_tech/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_app_tech/scss/bootstrap
...
* comment out this line in theme/boost_app_tech/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_app_tech/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_app_tech run "Grunt amd" to compile the bootstrap JS
