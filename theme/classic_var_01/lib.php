...
function theme_classic_var_01_get_main_scss_content($theme) {
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/classic_var_01/scss/classic_var_01/pre.scss');
    if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_classic_var_01', 'preset', 0, '/', $filename))) {
        ...
        $scss .= file_get_contents($CFG->dirroot . '/theme/classic_var_01/scss/preset/default.scss');
    }
    $scss .= file_get_contents($CFG->dirroot . '/theme/classic_var_01/scss/classic_var_01/post.scss');
