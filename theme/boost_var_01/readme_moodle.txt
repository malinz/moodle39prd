...
* remove folder theme/boost_var_01/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_var_01/scss/bootstrap
...
* comment out this line in theme/boost_var_01/scss/_print.scss
    @page {
