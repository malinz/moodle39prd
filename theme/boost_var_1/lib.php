 ...
 */
function theme_boost_var_1_css_tree_post_processor($tree, $theme) {
    $prefixer = new theme_boost_var_1\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return string
 */
function theme_boost_var_1_get_extra_scss($theme) {
    $content = '';
 ...
 * @return bool
 */
function theme_boost_var_1_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'logo' || $filearea === 'backgroundimage')) {
        $theme = theme_config::load('boost_var_1');
 ...
 * @return string
 */
function theme_boost_var_1_get_main_scss_content($theme) {
    global $CFG;
 ...
 */
function theme_boost_var_1_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/boost_var_1/style/moodle.css');
}
 ...
 * @return array
 */
function theme_boost_var_1_get_pre_scss($theme) {
    global $CFG;
