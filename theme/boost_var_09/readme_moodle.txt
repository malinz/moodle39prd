...
* remove folder theme/boost_var_09/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_var_09/scss/bootstrap
...
* comment out this line in theme/boost_var_09/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_var_09/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_var_09 run "Grunt amd" to compile the bootstrap JS
