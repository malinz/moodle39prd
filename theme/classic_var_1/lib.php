 ...
 * @return string
 */
function theme_classic_var_1_get_main_scss_content($theme) {
    global $CFG;
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/classic_var_1/scss/classic/pre.scss');
 ...
 * @return array
 */
function theme_classic_var_1_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 * @return string
 */
function theme_classic_var_1_get_extra_scss($theme) {
    global $CFG;
    $content = '';
    ...
    if (!empty($imageurl)) {
        ...
        $content .= file_get_contents($CFG->dirroot .
            '/theme/classic_var_1/scss/classic/body-background.scss');
    }

    if (!empty($theme->settings->navbardark)) {
        $content .= file_get_contents($CFG->dirroot .
            '/theme/classic_var_1/scss/classic/navbar-dark.scss');
    } else {
        $content .= file_get_contents($CFG->dirroot .
            '/theme/classic_var_1/scss/classic/navbar-light.scss');
    }
 ...
 */
function theme_classic_var_1_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/classic_var_1/style/moodle.css');
}
 ...
 * @return bool
 */
function theme_classic_var_1_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'backgroundimage')) {
        $theme = theme_config::load('classic_var_1');
