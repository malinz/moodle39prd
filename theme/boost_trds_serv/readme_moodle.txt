...
* remove folder theme/boost_trds_serv/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_trds_serv/scss/bootstrap
...
* comment out this line in theme/boost_trds_serv/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_trds_serv/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_trds_serv run "Grunt amd" to compile the bootstrap JS
