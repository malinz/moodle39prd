...
// Raw SCSS setting.
$string['choosereadme'] = 'Unitec Standard Default is a highly-customisable theme, based on Boost, with an alternative navigation layout. This theme is intended to be used directly, or as a parent theme when creating or updating custom themes to utilise Bootstrap 4.';
$string['configtitle'] = 'Unitec Standard Default';
...
$string['pluginname'] = 'Unitec Standard Default';
...
$string['privacy:metadata'] = 'The unitecstandard_default theme does not store any personal data.';
