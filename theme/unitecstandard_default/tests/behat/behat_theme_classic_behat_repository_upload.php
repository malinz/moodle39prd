...
/**
 * Override definitions for the upload repository type for the unitecstandard_default theme.
 *
...
/**
 * Override step definitions to deal with the upload repository in the unitecstandard_default theme.
 *
 * @package    theme_unitecstandard_default
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_unitecstandard_default_behat_repository_upload extends behat_repository_upload {
