...
/**
 * Step definitions related to administration overrides for the unitecstandard_default theme.
 *
...
/**
 * Site administration level steps definitions overrides for the unitecstandard_default theme.
 *
 * @package    theme_unitecstandard_default
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_unitecstandard_default_behat_admin extends behat_admin {
