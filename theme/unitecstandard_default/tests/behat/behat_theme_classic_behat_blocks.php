...
/**
 * Step definitions related to blocks overrides for the unitecstandard_default theme.
 *
...
/**
 * Blocks management step definitions for the unitecstandard_default theme.
 *
 * @package    theme_unitecstandard_default
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_unitecstandard_default_behat_blocks extends behat_blocks {
