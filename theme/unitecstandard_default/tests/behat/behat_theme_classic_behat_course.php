...
/**
 * Behat course-related step definition overrides for the unitecstandard_default theme.
 *
...
/**
 * Course-related step definition overrides for the unitecstandard_default theme.
 *
 * @package    theme_unitecstandard_default
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_unitecstandard_default_behat_course extends behat_course {
