...
/**
 * unitecstandard_default theme callbacks.
 *
 ...
 * @return string
 */
function theme_unitecstandard_default_get_main_scss_content($theme) {
    global $CFG;
 ...
 * @return array
 */
function theme_unitecstandard_default_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 * @return string
 */
function theme_unitecstandard_default_get_extra_scss($theme) {
    global $CFG;
    $content = '';
    ...
    if (!empty($imageurl)) {
        ...
        $content .= file_get_contents($CFG->dirroot .
            '/theme/unitecstandard_default/scss/classic/body-background.scss');
    }

    if (!empty($theme->settings->navbardark)) {
        $content .= file_get_contents($CFG->dirroot .
            '/theme/unitecstandard_default/scss/classic/navbar-dark.scss');
    } else {
        $content .= file_get_contents($CFG->dirroot .
            '/theme/unitecstandard_default/scss/classic/navbar-light.scss');
    }
 ...
 */
function theme_unitecstandard_default_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/unitecstandard_default/style/moodle.css');
}
 ...
 * @return bool
 */
function theme_unitecstandard_default_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'backgroundimage')) {
        $theme = theme_config::load('unitecstandard_default');
