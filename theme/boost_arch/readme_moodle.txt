...
* remove folder theme/boost_arch/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_arch/scss/bootstrap
...
* comment out this line in theme/boost_arch/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/boost_arch/amd/src/bootstrap (including the subfolder)
...
* in folder theme/boost_arch run "Grunt amd" to compile the bootstrap JS
